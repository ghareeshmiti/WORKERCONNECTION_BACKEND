  ...
  try {
    ...
    await client.query(`
      ALTER TABLE workers
        ...
        ADD COLUMN IF NOT EXISTS scheme_name TEXT DEFAULT 'State Health Scheme',
    ...
    const schemes = ['State Health Scheme', 'EHS', 'PMJAY', 'State Health Scheme', 'State Health Scheme', 'EHS', 'PMJAY', 'State Health Scheme'];
